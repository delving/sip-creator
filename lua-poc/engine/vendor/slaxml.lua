--[=====================================================================[
Vendored from Phrogz/SLAXML for lua-poc (Task 6, mapping-language-core.md
section "9. Lua ecosystem survey" / "9.1 XML parsing").

  Upstream:  https://github.com/Phrogz/SLAXML/blob/v0.8/slaxml.lua
  Tag:       v0.8
  Commit:    8a3e0c90325aa6d84ad23a7c13bf77247cb7f94e (2018-10-23)
  License:   MIT (full text: lua-poc/engine/vendor/SLAXML-LICENSE.txt)
  Pinned:    verbatim, unmodified — do not hand-edit; re-vendor to update.

Only slaxml.lua (the SAX layer) is vendored, not slaxdom.lua. lua-poc's
node.lua builds the GroovyNode-shaped tree directly from these SAX
callbacks (startElement/attribute/text/closeElement) instead of going
through slaxdom's generic DOM, since neither slaxdom's shape nor
xml2lua's is the GroovyNode four-lookup-forms shape anyway — the spec
requires a custom adapter regardless (mapping-language-core.md:930-933).
--]=====================================================================]
